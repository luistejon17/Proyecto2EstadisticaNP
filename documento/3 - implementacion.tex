...
La mediana y la media afeitada se implementan directamente con \texttt{numpy.median} y \texttt{scipy.stats.trim\_mean(\,\cdot\,, proportiontocut=0.1)}. El estimador $\hat\theta_{\min}$ requiere optimización numérica y se implementa de forma distinta para cada estadístico, aprovechando su estructura matemática (Sección~\ref{sec:estim-theta}).
