...
\begin{figure}[H]
  ...
  \caption{Densidades de las distribuciones empleadas. Izquierda: $H_0$, ambas simétricas en $\theta=2$ (línea gris). Derecha: $H_a$, las tres con asimetría positiva y soportes distintos.}
...
\begin{itemize}
  \item $\hat\theta_{\min}$: minimizador de $T_n$ (resp.\ $S_n$) sobre una cuadrícula uniforme en el rango de la muestra.
