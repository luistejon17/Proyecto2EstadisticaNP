...
\paragraph{Efecto de $q$.} La Figura~\ref{fig:sn-q} muestra que $q=1$ es generalmente más potente que $q=2$ para los estimadores mediana y media afeitada. Esto es consistente con la interpretación de que $q=1$ penaliza linealmente las desviaciones de simetría en $c_n(t)e^{-it\hat\theta}$, siendo más sensible a discrepancias moderadas y distribuidas, mientras que $q=2$ amplifica solo las grandes. Con media afeitada, $q=1$ supera a $q=2$ especialmente bajo Weibull ($91\%$ vs.\ $88.5\%$ en $n=80$; $50\%$ vs.\ $42\%$ en $n=40$) y Gamma ($93\%$ vs.\ $74\%$ en $n=80$). Para mediana bajo Gamma, $q=2$ puede superar a $q=1$ en tamaños intermedios ($39\%$ vs.\ $31.5\%$ en $n=40$), aunque $q=1$ recupera ventaja a $n=160$ ($99\%$ vs.\ $94.5\%$).
