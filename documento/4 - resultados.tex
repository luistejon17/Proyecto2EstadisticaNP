...
\paragraph{Efecto de $q$.} El efecto de $q$ depende del estimador y la distribución. Para el estimador \textbf{argmin} (Figura~\ref{fig:compare-potencia}), $q=2$ domina claramente bajo Pareto ($49\%$ vs.\ $30.5\%$ en $n=40$) y Weibull ($87\%$ vs.\ $64\%$ en $n=80$), siendo $q=1$ competitivo únicamente bajo Gamma ($54\%$ vs.\ $31\%$ en $n=40$). Para la \textbf{mediana} (Figura~\ref{fig:sn-q}), los resultados son mixtos: $q=2$ aventaja en algunos escenarios ($39\%$ vs.\ $31.5\%$ bajo Gamma con $n=40$), pero $q=1$ es mejor en otros ($99\%$ vs.\ $94.5\%$ bajo Gamma con $n=160$). Para la \textbf{media afeitada}, $q=1$ tiene ventaja consistente bajo Gamma ($93\%$ vs.\ $74\%$ en $n=80$) y Weibull ($91\%$ vs.\ $88.5\%$ en $n=80$). En conjunto, $q=2$ es preferible cuando se usa argmin (aprovecha mejor el gradiente suave), mientras que $q=1$ puede ser mejor con estimadores robustos del centro.
