...
El estimador \textbf{mediana} controla el nivel de forma aceptable bajo Cauchy ($2$--$3\%$), pero resulta ligeramente liberal bajo Uniforme ($6$--$9\%$), superando las bandas de un error estándar para $n\ge 40$. La \textbf{media afeitada} es marcadamente conservadora bajo Uniforme ($0.3$--$3.3\%$) y se aproxima al nivel nominal bajo Cauchy ($3$--$7\%$). Las discrepancias observadas son coherentes con variabilidad Monte Carlo ($\mathrm{SE}_R\approx 1.3\%$ para $R=300$).
